                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="login-container">
                            ...
                            <form action="#" method="post">
                                <div class="mb-3">
                                    <center><img src="<?php echo $product['chemin']; ?>" width="100" height="100" style="border-radius:5px;">
                                    </center><br>
                                    <label for="name"><b>Name</b></b></label>
                                    <input type="text" class="form-control" name="nom" value="<?php echo $product['nom']; ?>" placeholder="Product Name" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="prix"><b>Price</b></label>
                                    <input type="text" class="form-control" name="prix" value="<?php echo $product['prix']; ?>" placeholder="Product prix" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="taille"><b>Size</b></label>
                                    <input type="text" class="form-control" name="taille" value="<?php echo $product['taille']; ?>" placeholder="Xs, S, M, L, XL" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="couleur"><b>Color</b></label>
                                    <input type="text" class="form-control" name="couleur" value="<?php echo $product['couleur']; ?>" placeholder="Red, Blue, Green..." readonly>
                                </div>
                                <div class="mb-3">
